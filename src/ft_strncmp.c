...
{
// Note: I do not find the issue with the code.
// It seems like there is a misscalculation with n when doing the alignment down of v1.
...
//	v1 = (vector*)(((uintptr)v1) & ~(VecSize * 4 - 1));
//	v2 = (vector*)((uintptr)v2 + (uintptr)v1);
//	n -= ((uintptr)v1 - (uintptr)s1);
//
//	while (true)
//	{
//		n -= VecSize * 4;
...
//			}
//
//			mask = BitScanForward(MoveMask_uint8(CmpEq_int8(cp3, zero)));
//			if (mask > n - VecSize)
//			{
//				return 0;
//			}
